...
class BooksView(ctk.CTkFrame):
    def __init__(self, master):
        ...
        view_names = ['all books', 'available books', 'unavailable books']
        ...
        self.delete_button = ctk.CTkButton(self.control_buttons, corner_radius=0, text='Remove',
                                           text_color='#ffffff', font=ctk.CTkFont(size=15),
